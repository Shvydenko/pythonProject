...
// this.engine = engine
// this.drive = function (){
//     console.log(`Їдемо зі швидкістю ${maxSpeed}км за годину`)}
//     this.info = function () {
//     console.log (`${this.model} ${this.manufacturer} ${this.year} ${this.maxSpeed} ${this.engine}`);
//     }
...
//     this.year = 'newValue'
// }
// this.addDrive = function (driver = 'Parnisha'){
//     this.driver = driver
// }
// }
// let Toyota = new Car ('toyota','Japan',2015,200,2.5);
// Toyota.drive()
// Toyota.info()
// Toyota.increaseMaxSpeed()
// Toyota.changeYear()
// Toyota.addDrive()
// console.log(Toyota);
